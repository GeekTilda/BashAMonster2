...
/*
    ...
    public static JFrame drawWindow(Friend friend, Friend friend2) {
        JFrame frame = new JFrame("Healthbar: " + friend.getName() + " & " + friend2.getName()); //create the window
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //Set action on closing window
        Healthbar healthbar = new Healthbar(friend, friend2); //Create the canvas
